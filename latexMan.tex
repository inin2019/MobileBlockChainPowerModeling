...
\begin{abstract}
  ...
  In regard of related work, there is a research about a blockchain system for mobile systems\cite{Suankaewmanee}, 
  and an energy model for blockchain consensus algorithm \cite{Cole} \cite{Zehui}. Also, blockchain edge is researched in \cite{Yang} \cite{He} \cite{Yutao}. Deep learning approaches are researched in \cite{Nguyen} \cite{Dinh}. There is a research about wireless mobile miners \cite{Gilsoo} and also energy systems are researched in \cite{Ruzanna} \cite{Wang}. 
\end{abstract}
